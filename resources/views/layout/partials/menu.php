<?php if($_SESSION['auth']->id_rol == 1 || $_SESSION['auth']->id_rol == 3): ?>

    <h3 style="border-bottom: 1px solid #000;">Menú administrativo</h3>
    ...
    <strong class="a-item">
        <a href="/usuarios">           
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-folder2" viewBox="0 0 16 16">
...
<?php else :?>
    ...
    <h3 style="border-bottom: 1px solid #000;">Menú</h3>     
    ...
    <strong class="a-item">
        <a href="/perfil/<?= $_SESSION['auth']->name ?>">            
    ...
    <strong class="a-item">
        <a href="/desechados/<?= $_SESSION['auth']->name ?>">            
